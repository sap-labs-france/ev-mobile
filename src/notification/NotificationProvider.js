...
export default class NotificationProvider {
  ...
  async sendNotification({id = ++this.lastId, title = "Title", message = "Message", bigText, subText, color = "red", vibrate = true, vibrationMillis = 300, playSound = true, date}) {
    // Create notif object
    const notification = {
      ...
      tag: 'eMobility', // (optional) add tag to message
      group: "eMobility", // (optional) add group to message
