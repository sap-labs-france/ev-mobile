...
export default class ConnectorComponent extends ResponsiveComponent {
  ...
  _renderFirstConnectorDetails = (connector, style) => {
    return (
      <ConnectorStatusComponent style={[style.statusConnectorDetail, style.statusConnectorDetailLetter]} connector={connector}/>
    );
  }
        ...
        <TouchableOpacity style={style.statusLeftRightConnectorContainer}
          ...
          <Animatable.View animation={even ? "slideInLeft" : "slideInRight"} iterationCount={1} >
            <View style={even ? [style.connectorContainer, style.leftConnectorContainer] : [style.connectorContainer, style.rightConnectorContainer]}>
              ...
              :
                <View style={[style.statusConnectorDetailContainer, style.rightStatusConnectorDetailContainer]}>
                  {this._renderThirdConnectorDetails(connector, style)}
                  {this._renderSecondConnectorDetails(connector, style)}
                  {this._renderFirstConnectorDetails(connector, style)}
                </View>
