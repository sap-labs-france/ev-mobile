...
export default class AddReservation extends BaseScreen<Props, State> {
  ...
  public async componentDidMount(): Promise<void> {
    ...
    const roundUpDateTime = moment().minute(Math.ceil(moment().minute() / 5) * 5).second(0);
    this.setState(
      {
        ...
        selectedConnector,
        fromDate: roundUpDateTime.toDate(),
        toDate: roundUpDateTime.clone().add(1, 'd').toDate(),
        arrivalTime: roundUpDateTime.toDate(),
        departureTime: roundUpDateTime.clone().add(1, 'h').toDate(),
        expiryDate: roundUpDateTime.clone().add(1, 'h').toDate(),
