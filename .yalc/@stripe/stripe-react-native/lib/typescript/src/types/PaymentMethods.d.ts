...
export declare namespace PaymentMethodCreateParams {
    type Params = CardParams | IdealParams | OxxoParams | P24Params | AlipayParams | GiropayParams | SepaParams | EpsParams | SofortParams | GrabPayParams | FPXParams | AfterpayClearpayParams | BancontactParams;
    type BillingDetails = {
        email?: string;
        name?: string;
        phone?: string;
